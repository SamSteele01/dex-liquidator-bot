...
// import LendingPoolAddressProviderAbi from './abi/LendingPoolAddressProvider.json';
...
const LendingPoolAddressProviderAbi = require('./abi/LendingPoolAddressProvider.json');
const LendingPoolCoreAbi = require('./abi/LendingPoolCore.json');
import { AbiItem } from 'web3-utils';

const aTokenAbi: AbiItem[] = ATokenAbi;
const lendingPoolAbi: AbiItem[] = LendingPoolAbi;
const lendingPoolAddressProviderAbi: AbiItem[] = LendingPoolAddressProviderAbi;
const lendingPoolCoreAbi: AbiItem[] = LendingPoolCoreAbi;
